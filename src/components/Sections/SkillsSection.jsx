  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y }} className="absolute inset-0 overflow-hidden">
        <div
          className={`absolute top-40 right-1/4 w-72 h-22 rounded-full blur-3xl opacity-5 ${
            ...
            >
              ...
              <div className="flex items-center mb-6">
                ...
                >
                  <category.icon 
                  size={24} 
                  className={isDarkMode ? "text-blue-500" : "text-gray-700"} 
                />
                </div>
            ...
            >
                {TECH_STACK.map((tech, index) => (
                    ...
                    className={`px-4 py-2 text-sm rounded-full border transition-all duration-300 ${
                        isDarkMode
                        ? "bg-gray-900 border-gray-700 text-gray-300 hover:border-gray-600-600"
