...
const ProjectsSection = () => {
  ...
  // ✅ SEO meta update without react-helmet-async
  useEffect(() => {
    document.title = "Projects | Bajrang Wavare";
    ...
    if (descriptionMeta) {
      descriptionMeta.setAttribute(
        "content",
        "Explore Bajrang Wavare's collection of modern web development projects, showcasing expertise in React, Node.js, and building real-world applications."
      );
    } else {
    ...
    canonicalLink.href = "https://bajrangwavare.in/projects";
  }, []);
