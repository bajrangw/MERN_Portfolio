  ...
  return (
    ...
    >
      ...
      <motion.section
        id="home"
        style={{ y: heroY }}
        className="min-h-screen w-full flex items-center justify-center relative px-6 pt-10"
      >
        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center w-full">
            ...
            {/* Right Column - Profile Image and Tech Stack - fully inside column */}
            <motion.div
              initial="hidden"
              animate="visible"
            ...
            >
              <div className="relative w-96 h-91 flex flex-col items-center">
                {/* Tech Stack - Desktop */}
                <motion.div
                  variants={itemVariants}
                  className="flex items-center space-x-8 text-xs uppercase tracking-widest absolute -top-10 left-1/2 transform -translate-x-1/2"
                >
                  <span className={isDarkMode ? "text-gray-600" : "text-gray-500"}>React</span>
                  <span className={isDarkMode ? "text-gray-700" : "text-gray-400"}>.</span>
                  <span className={isDarkMode ? "text-gray-600" : "text-gray-500"}>Node.js</span>
                ...
                <motion.div
                  ...
                  className={`w-75 h-91 rounded-3xl overflow-hidden border-4 ${
                    isDarkMode ? "border-gray-800" : "border-gray-300"
                  } shadow-2xl`}
                >
                  <img
                ...
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  className="absolute inset-0 rounded-3xl border border-blue-500/20 pointer-events-none"
                />
                <motion.div
                  animate={{ rotate: -360 }}
                  transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                  className="absolute inset-0 rounded-3xl border border-purple-500/10 pointer-events-none"
                />
              </div>
            </motion.div>
          </div>
